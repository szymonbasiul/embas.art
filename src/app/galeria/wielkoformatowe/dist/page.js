...
var Wielkoformatowe = function () {
    var _a = react_1.useState(0), currentIndex = _a[0], setCurrentIndex = _a[1];
    var prevImage = function () {
        setCurrentIndex(function (prev) { return (prev === 0 ? wideImages.length - 1 : prev - 1); });
    };
    var nextImage = function () {
        setCurrentIndex(function (prev) { return (prev === wideImages.length - 1 ? 0 : prev + 1); });
    };
    return (React.createElement("div", { className: "h-screen flex flex-col justify-between bg-dark bg-opacity-90 py-6 px-4 sm:px-6" },
        React.createElement("h2", { className: "text-3xl font-bold text-center text-beigeLight mb-6" }, "Galeria Wielkoformatowa"),
        ...
        React.createElement("div", { className: "relative w-full flex justify-center items-center" },
            ...
            React.createElement("div", { className: "w-full flex justify-center items-center overflow-x-auto" },
                React.createElement("div", { className: "flex sm:flex-nowrap flex-wrap justify-center items-center sm:gap-4 gap-6" },
                    React.createElement(image_1["default"], { src: wideImages[currentIndex], alt: "Wielkoformatowe " + (currentIndex + 1), className: "rounded-lg shadow-lg max-w-full sm:max-w-[800px] max-h-[500px] sm:max-h-[600px] object-contain transition-all duration-300 ease-in-out", width: 800, height: 600, quality: 75, priority: true }))),
...
exports["default"] = Wielkoformatowe;
